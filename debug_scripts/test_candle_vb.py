...
# Test with a completely different name in a different dir
os.makedirs('temp_test', exist_ok=True)
import shutil
shutil.copy('pretrained_models/Fun-CosyVoice3-0.5B/hift.safetensors', 'temp_test/random_name.safetensors')
test_load('temp_test/random_name.safetensors')
